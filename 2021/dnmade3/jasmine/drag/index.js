        ...
        screenCoordsToDirection(
            ...
            */
            ...
            const {
                ...
                y,
                z
            } = projectedVector.sub(cameraPosAsVec3).normalize();
            return {
                x,
                y,
                z
...
} = (function directionToWorldCoordsFunction() {
    ...
    return {
        ...
        directionToWorldCoords(
            ...
            const {
                ...
                y,
                z
            } = newPosition.add(cameraPosAsVec3);
...
const {
    didMount,
    didUnmount
} = (function getDidMountAndUnmount() {
    ...
    function initialize(THREE, componentName) {
        ...
        function onMouseDown({
            ...
            const {
                ...
                offset,
                element
            } = selectItem(THREE, componentName, camera, clientX, clientY);
